...
char const CreatureModelDatafmt[] = "nisxfxxxxxxxxxxffxxxxxxxxxxxxxfxxx";
...
char const SpellTargetRestrictionsEntryfmt[] = "nxxfxiiii";
...
char const TalentEntryfmt[] = "nxiiiiiiiix";
