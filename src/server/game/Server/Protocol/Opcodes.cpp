...
#define DEFINE_HANDLER(opcode, status, processing, handler) \
    ...
    DEFINE_HANDLER(CMSG_ACTIVATE_TAXI_EXPRESS,                            STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleActivateTaxiExpressOpcode );
    ...
    DEFINE_HANDLER(CMSG_BATTLE_PAY_DISTRIBUTION_SELECT_CHOICE,            STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    DEFINE_HANDLER(CMSG_CHAR_FACTION_OR_RACE_CHANGE,                      STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleCharFactionOrRaceChange   );
    ...
    DEFINE_HANDLER(CMSG_DUEL_PROPOSED,                                    STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleDuelProposedOpcode        );
    ...
    DEFINE_HANDLER(CMSG_ENABLE_TAXI,                                      STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleTaxiQueryAvailableNodes   );
    ...
    DEFINE_HANDLER(CMSG_GM_TICKET_CREATE,                                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGMTicketCreateOpcode      );
    DEFINE_HANDLER(CMSG_GM_TICKET_DELETE_TICKET,                          STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGMTicketDeleteOpcode      );
    DEFINE_HANDLER(CMSG_GM_TICKET_GET_TICKET,                             STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGMTicketGetTicketOpcode   );
    DEFINE_HANDLER(CMSG_GM_TICKET_SYSTEM_STATUS,                          STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGMTicketSystemStatusOpcode);
    DEFINE_HANDLER(CMSG_GM_TICKET_CASE_STATUS,                            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGMTicketCaseStatusOpcode  );
    DEFINE_HANDLER(CMSG_GM_TICKET_UPDATE_TEXT,                            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGMTicketUpdateOpcode      );
    ...
    DEFINE_HANDLER(CMSG_BATTLEFIELD_RATED_INFO_REQUEST,                   STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleRequestRatedBgInfo        );
    ...
    DEFINE_HANDLER(CMSG_TIME_SYNC_RESPONSE,                               STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleTimeSyncResp              );
...
#define DEFINE_SERVER_OPCODE_HANDLER(opcode, status, con) \
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GM_RESPONSE_STATUS_UPDATE,                        STATUS_NEVER,       CONNECTION_TYPE_REALM);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GM_TICKET_UPDATE,                                 STATUS_NEVER,       CONNECTION_TYPE_REALM);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GM_TICKET_GET_TICKET,                             STATUS_NEVER,       CONNECTION_TYPE_REALM);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GM_TICKET_SYSTEM_STATUS,                          STATUS_NEVER,       CONNECTION_TYPE_REALM);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GM_TICKET_UPDATE_TEXT,                            STATUS_NEVER,       CONNECTION_TYPE_REALM);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GUILD_QUERY_INFO_RESPONSE,                        STATUS_NEVER,       CONNECTION_TYPE_REALM);
...
#define DEFINE_MSG_OPCODE_HANDLER(opcode, status, processing, handler, con) \
    ...
    DEFINE_MSG_OPCODE_HANDLER(SMSG_SPELL_CHANNEL_UPDATE,                                    STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide,                  CONNECTION_TYPE_REALM);
